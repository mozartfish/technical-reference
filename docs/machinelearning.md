...
---
## Background 
This page is a list of everything that I have found to learn machine learning in the llm chatgpt era. I used a lot of these references during my undergrad and I discovered new resources and courses that helped me study for some of the challenging courses during my time at KTH. [Kylie Ying](https://youtube.com/playlist?list=PLkWv3oO4kHnu095L52vLCVK8YN33yRrd_&feature=shared), [Chip Huyen](https://huyenchip.com), [Josh Starmer](https://statquest.org) were a huge inspiration for this page because of how they organized the content on their websites and youtube channels. 

 
## Introduction 
* ***The Worlds I See: Curiosity, Exploration, and Discovery at the Dawn of AI*** by [Fei-Fei Li](https://profiles.stanford.edu/fei-fei-li)
* [Silivia Sapora Interviewing for Machine Learning Positions](https://silviasapora.github.io/blog/ml-interviews.html)
...
* [3B1B Information Theory](https://youtu.be/l6DKRf-fAAM?si=3UNibWMeTxZ9o_UD)
...
* [Sasha Rush LLM-Training-Puzzles](https://github.com/srush/LLM-Training-Puzzles)
* [Sasha Rush GPU-Puzzles](https://github.com/srush/gpu-puzzles)
* [Sasha Rush Autodiff-Puzzles](https://github.com/srush/Autodiff-Puzzles)
* [Sasha Rush Tensor-Puzzles](https://github.com/srush/Tensor-Puzzles)
* [Sasha Rush Tensor-Puzzles-Penzai](https://github.com/srush/Tensor-Puzzles-Penzai)
* [Sasha Rush Transformer-Puzzles](https://github.com/srush/Transformer-Puzzles)
* [Sasha Rush GPTWorld(Prompting Puzzle)](https://github.com/srush/GPTWorld)
* [Neetcode Versus](https://neetcode.io/versus)
...
### Modern Language Modeling and NLP 
...
* [Stanford CS 231N - Deep Learning for Computer Vision 2025 Lectures](https://youtu.be/2fq9wYslV0A?si=VInIphk-S3WhhQGJ)
#### Computational Photography 
- [Berkeley CS 180/280A - Intro to Computer Vision and Computational Photography](https://cal-cs180.github.io/fa25/)
...
## Agents 
* [Utah CS 6960 - Multimodal LLM Agents](https://sparklabutah.github.io/Multimodal-LLM-Agents-Course-Public/)

## Applied AI 
These resources focus mostly on particular tools and libraries for applying recent AIML advancements to industrial problems and applications.

* [HuggingFace Courses](https://huggingface.co/learn)


## Bleeding Edge - (Last Updated: July 2026)
...
- [David Silver DeepMind Reinforcement Learning](https://davidstarsilver.wordpress.com/teaching/)
...
* [Harvard CS 73 - Code, Data, Art](https://wattenberg.github.io/cs73/)
...
* [How to Scale Your Models](https://jax-ml.github.io/scaling-book/)
